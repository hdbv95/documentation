---
title: Use Terraform and Ansible to Deploy Redpanda
---

<head>
    <meta name="title" content="Use Terraform and Ansible to deploy Redpanda | Redpanda Docs"/>
    <meta name="description" content="Use Terraform and Ansible to deploy Redpanda."/>
</head>

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

You can deploy Redpanda for production on [bare metal with the Redpanda installation binary](../../deployment/production-deployment).
...
Now you can install Redpanda either with the [Redpanda installation binary](../../deployment/production-deployment) or with Ansible.
