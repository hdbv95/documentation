---
title: Creating a BYOC Cluster on GCP
---
...
1. Go to cloudv2.repanda.com and click **Log in**.
...
* Setup the gcloud [application-default](https://cloud.google.com/sdk/gcloud/reference/auth/application-default/login) credentials.
    ...
    To temporarily use your user credentials for API access, run: `gcloud auth application-default login`. This command opens Google's log in page in a browser window.
