---
title: Create a Dedicated Cloud Cluster on AWS
---
...
If you chose **Private - VPC Peering** for your connection type, see [Adding a VPC Peering Connection](/docs/cloud/vpc-peering) to connect your VPC to the Redpanda Cloud VPC.