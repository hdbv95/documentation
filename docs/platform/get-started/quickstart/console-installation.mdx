...
The recommended way to get started with Redpanda Console on a local machine is to start Redpanda platform with Docker compose. Refer to [Docker Compose](../console/reference/docker-compose.mdx) for details about launching Redpanda platform locally.
...
:::note
Refer to the [Console reference config](../console/reference/config.mdx) for a full list of configurations.
:::
...
- [Redpanda Console Configuration](../../console/reference/config) - Main configuration file for Redpanda Console
- [Redpanda Console Role Binding Configuration](../../console/reference/role-bindings) - Role binding configuration for RBAC
