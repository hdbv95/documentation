...
The recommended way to get started with Redpanda Console on a local machine is to start Redpanda platform with Docker compose. Refer to [Docker Compose](../console/reference/docker-compose) for details about launching Redpanda platform locally.
...
:::note
Refer to the [Console reference config](../console/reference/config) for a full list of configurations.
:::
