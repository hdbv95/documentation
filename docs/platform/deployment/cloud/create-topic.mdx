...
6. (Optional) Under **Additional Configuration**, add more topic properties.
    ...
    Redpanda supports all Apache Kafka topic configuration properties and all Redpanda-specific [topic configuration properties](../../platform/reference/cluster-properties#topics-and-partitions).
7. Click **Create**.
