---
title: Configure Redpanda SASL on Kubernetes
---

<head>
    <meta name="title" content="Configure Redpanda SASL on Kubernetes | Redpanda Docs"/>
    <meta name="description" content="Configure Redpanda SASL on Kubernetes."/>
</head>
